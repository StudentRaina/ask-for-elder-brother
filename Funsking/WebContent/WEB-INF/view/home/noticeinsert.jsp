...
<div id="topFrame">
	...
	<hr/>
 	...
 	<h2 id="h2_busi_intr">공지사항</h2>
		...
		<form action="fileUploadAjax" id="insertForm"
	  			  method="post" enctype="multipart/form-data">
		<input type="hidden" name="memNo" value="${sFuserNUM}"/>
 	 		...
 	 		<tr id="tr3">
 	 			<td>
 	 			 <textarea rows="5" cols="600" name="textCon" id="text1" >
					</textarea>
