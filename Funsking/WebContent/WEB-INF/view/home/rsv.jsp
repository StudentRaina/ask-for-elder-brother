...
function checkdate(){
   ...
   /*  console.log(dp+"dp값");
	...
	// console.log($('[name="sche"]').val()); clear
    
    //console.log(gu+"gu값");
    //console.log(place+"place값");
    //console.log(dd+"se3의값."); 
   	
   	//console.log("se1  "+$("#se1").val());
   	
   /* 	console.log("구속성값"+$("[name=gu]").val());
	console.log("장소 값"+$("[name=place]").val());
   	console.log("요일       "+$("[name=sche]").val()); */
